...
(function() {
    ...
    function buildSettingsPanel() {
        ...
        html += '</div>';
        html += '<div class="sec">DISPLAY MODE</div>';
        html += '<label style="display:inline-flex;align-items:center;gap:6px;cursor:pointer"><input type="checkbox" id="s-show-pct" ' + (saved.showPct ? "checked" : "") + ' style="accent-color:#ff9900"> Show S/M/L as % of target</label>';
